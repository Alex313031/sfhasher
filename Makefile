# SFHasher MAKEFILE for compiling under MinGW32
...
# Libraries
LIBS     := -lkernel32 -luser32 -lcomctl32 -lcomdlg32 -lshell32 -lgdi32 -ladvapi32
# Linker flags
...
# The only target for now is sfhash.exe
$(NAME): $(TARGET)
