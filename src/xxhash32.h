...
#ifndef SFHASHER_XXHASH32_H_
#define SFHASHER_XXHASH32_H_

#include <framework.h> // for uint32_t and uint64_t
...
private:
  ...
  static const uint32_t MaxBufferSize = 15U + 1U;
